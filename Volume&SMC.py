...
//EMAs Indicator
// Input for the length of the 50-period EMA
ema50_length = input(50, title="EMA 50 Length")

// Input for the length of the 200-period EMA
...
// Plot EMAs
plot(ema50, color=color.rgb(255, 225, 0), title="EMA 50")
plot(ema200, color=color.rgb(145, 0, 207), title="EMA 200")
